...
const Skiper4 = ({ isDark, onToggle }) => {
  return (
    <div className="flex items-center justify-center">
      <ThemeToggleButton1 className={cn("size-10")} isDark={isDark} onToggle={onToggle} />
    </div>
  );
};
...
export const ThemeToggleButton1 = ({ className = "", isDark, onToggle }) => {
  return (
    <button
      type="button"
      className={cn(
...
export const ThemeToggleButton2 = ({ className = "", isDark, onToggle }) => {
  return (
    <button
      type="button"
      className={cn(
...
export const ThemeToggleButton3 = ({ className = "", isDark, onToggle }) => {
  return (
    <button
      type="button"
      className={cn(
...
export const ThemeToggleButton4 = ({ className = "", isDark, onToggle }) => {
  return (
    <button
      type="button"
      className={cn(
...
export const ThemeToggleButton5 = ({ className = "", isDark, onToggle }) => {
  return (
    <button
      type="button"
      className={cn(
